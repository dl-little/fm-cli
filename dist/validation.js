...
export const validateUri = (value) => {
    const parsedValue = String(value);
    if (!parsedValue.startsWith('mongodb://') &&
...
export const validateType = (value) => {
    ...
    if (!options.includes(parsedValue)) {
        throw new InvalidArgumentError("Type must be of one of these types: 'employee', 'product', 'credit_card', 'bank_account', 'user'");
    }
    return parsedValue;
};
