...
import { validateInt, validateUri, validateType, validateAnswers, } from './validation.js';
...
program
    ...
    .option('-t, --type <type>', 'Select the type of faker object to create', validateType);
